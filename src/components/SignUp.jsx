...
function SignUp() {
  ...
  const onSubmit = (data) =>
    fetch(`http://localhost:3000/login`).then((resp) => {
  ...
  return (
    <>
      <form
        className="bg-gray-800 p-4 w-full"
      ...
      >
        ...
        <div className="max-w-2xl mx-auto">
          <div class=" px-8 pt-6 pb-8 mb-4 flex flex-col bg-white shadow-md rounded">
            <div class="mb-4">
            ...
            <div class="mb-6">
              ...
              <ErrorMessage
                errors={errors}
                name="Password"
                message="Password is  is required"
              />
            </div>
            <div className="flex justify-between ">
              ...
              />
              <Link class="text-blue-500 underline" to="/login">
